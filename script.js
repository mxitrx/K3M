document.addEventListener('DOMContentLoaded', () => {
    ...
    const allProducts = [
        ...
        },
        {
            ...
            stock: 1,
            status: "available", // available, low, out
            image: "https://gw.alicdn.com/imgextra/i1/301776238/O1CN01luYGpI1vx3S9aA3Zy_!!301776238.jpg",
            items: "Body Canon EOS 70D, Lens 18-135mm, แบตเตอรี่ Canon LP-E6N (2 ก้อน), แท่นชาร์จ, SD Card 64GB, Soft Case"
        },
        {
            id: "WLS-DJI-SDR",
            category: "wireless",
